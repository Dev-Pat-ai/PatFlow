...
public final class IncomeDao_Impl implements IncomeDao {
  ...
  private final EntityInsertionAdapter<IncomeCategoryEntity> __insertionAdapterOfIncomeCategoryEntity_1;

  private final EntityInsertionAdapter<IncomeSourceEntity> __insertionAdapterOfIncomeSourceEntity_1;

  private final EntityInsertionAdapter<IncomeEntryEntity> __insertionAdapterOfIncomeEntryEntity_1;
  ...
  private final SharedSQLiteStatement __preparedStmtOfDeleteAllSources;
  ...
  public IncomeDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfIncomeSourceEntity = new EntityInsertionAdapter<IncomeSourceEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "INSERT OR ABORT INTO `income_source` (`id`,`category_id`,`name`,`default_amount`,`recurrence_type`,`recurrence_interval`,`start_date`,`end_date`,`is_active`,`is_archived`,`is_deleted`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?,?)";
      }
    ...
    this.__insertionAdapterOfIncomeCategoryEntity_1 = new EntityInsertionAdapter<IncomeCategoryEntity>(__db) {
      @Override
      @NonNull
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `income_category` (`id`,`name`,`icon_key`,`color_hex`,`is_custom`) VALUES (nullif(?, 0),?,?,?,?)";
      }
    ...
    this.__insertionAdapterOfIncomeSourceEntity_1 = new EntityInsertionAdapter<IncomeSourceEntity>(__db) {
      @Override
      @NonNull
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `income_source` (`id`,`category_id`,`name`,`default_amount`,`recurrence_type`,`recurrence_interval`,`start_date`,`end_date`,`is_active`,`is_archived`,`is_deleted`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?,?)";
      }
    ...
    this.__insertionAdapterOfIncomeEntryEntity_1 = new EntityInsertionAdapter<IncomeEntryEntity>(__db) {
      @Override
      @NonNull
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `income_entry` (`id`,`income_source_id`,`category_id`,`amount`,`currency_code`,`entry_date`,`note`,`created_at`) VALUES (nullif(?, 0),?,?,?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfIncomeSourceEntity = new EntityDeletionOrUpdateAdapter<IncomeSourceEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `income_source` SET `id` = ?,`category_id` = ?,`name` = ?,`default_amount` = ?,`recurrence_type` = ?,`recurrence_interval` = ?,`start_date` = ?,`end_date` = ?,`is_active` = ?,`is_archived` = ?,`is_deleted` = ? WHERE `id` = ?";
      }
    ...
    this.__preparedStmtOfDeleteAllCategories = new SharedSQLiteStatement(__db) {
      ...
      public String createQuery() {
        final String _query = "DELETE FROM income_category";
        return _query;
      }
    };
    this.__preparedStmtOfDeleteAllSources = new SharedSQLiteStatement(__db) {
      @Override
      @NonNull
      public String createQuery() {
    ...
    this.__preparedStmtOfDeleteAllEntries = new SharedSQLiteStatement(__db) {
      ...
      @NonNull
      public String createQuery() {
        final String _query = "DELETE FROM income_entry";
        return _query;
      }
    };
  }
  ...
  @Override
  public Object insertAllCategories(final List<IncomeCategoryEntity> categories,
    ...
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      ...
      public Unit call() throws Exception {
        __db.beginTransaction();
        try {
          __insertionAdapterOfIncomeCategoryEntity_1.insert(categories);
          __db.setTransactionSuccessful();
  ...
  @Override
  public Object insertAllSources(final List<IncomeSourceEntity> sources,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        __db.beginTransaction();
        try {
          __insertionAdapterOfIncomeSourceEntity_1.insert(sources);
          __db.setTransactionSuccessful();
          return Unit.INSTANCE;
        } finally {
          __db.endTransaction();
  ...
  @Override
  public Object insertAllEntries(final List<IncomeEntryEntity> entries,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        __db.beginTransaction();
        try {
          __insertionAdapterOfIncomeEntryEntity_1.insert(entries);
          __db.setTransactionSuccessful();
          return Unit.INSTANCE;
        } finally {
          __db.endTransaction();
  ...
  @Override
  public Object deleteAllSources(final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        final SupportSQLiteStatement _stmt = __preparedStmtOfDeleteAllSources.acquire();
        try {
          __db.beginTransaction();
          try {
            _stmt.executeUpdateDelete();
          ...
          __preparedStmtOfDeleteAllSources.release(_stmt);
        }
      }
    }, $completion);
  }
      ...
      public IncomeSourceEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new IncomeSourceEntity(_tmpId,_tmpCategoryId,_tmpName,_tmpDefaultAmount,_tmpRecurrenceType,_tmpRecurrenceInterval,_tmpStartDate,_tmpEndDate,_tmpIsActive,_tmpIsArchived,_tmpIsDeleted);
          } else {
            _result = null;
          }
          return _result;
      ...
      public List<IncomeSourceEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _tmp_5 = _cursor.getInt(_cursorIndexOfIsDeleted);
            _tmpIsDeleted = _tmp_5 != 0;
            _item = new IncomeSourceEntity(_tmpId,_tmpCategoryId,_tmpName,_tmpDefaultAmount,_tmpRecurrenceType,_tmpRecurrenceInterval,_tmpStartDate,_tmpEndDate,_tmpIsActive,_tmpIsArchived,_tmpIsDeleted);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Object getAllCategoryEntities(
      final Continuation<? super List<IncomeCategoryEntity>> $completion) {
    final String _sql = "SELECT * FROM income_category";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    final CancellationSignal _cancellationSignal = DBUtil.createCancellationSignal();
  ...
  @Override
  public Object getAllSourceEntities(
      final Continuation<? super List<IncomeSourceEntity>> $completion) {
    final String _sql = "SELECT * FROM income_source";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    final CancellationSignal _cancellationSignal = DBUtil.createCancellationSignal();
    return CoroutinesRoom.execute(__db, false, _cancellationSignal, new Callable<List<IncomeSourceEntity>>() {
      @Override
      @NonNull
      public List<IncomeSourceEntity> call() throws Exception {
        final Cursor _cursor = DBUtil.query(__db, _statement, false, null);
  ...
  @Override
  public Object getAllEntryEntities(
      final Continuation<? super List<IncomeEntryEntity>> $completion) {
    final String _sql = "SELECT * FROM income_entry";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    final CancellationSignal _cancellationSignal = DBUtil.createCancellationSignal();
