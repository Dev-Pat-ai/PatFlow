...
public final class SavingsGoalDao_Impl implements SavingsGoalDao {
  ...
  private final EntityInsertionAdapter<SavingsGoalEntity> __insertionAdapterOfSavingsGoalEntity_1;

  private final EntityInsertionAdapter<SavingsContributionEntity> __insertionAdapterOfSavingsContributionEntity_1;
  ...
  private final SharedSQLiteStatement __preparedStmtOfDeleteAllContributions;
  ...
  public SavingsGoalDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfSavingsGoalEntity = new EntityInsertionAdapter<SavingsGoalEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR ABORT INTO `savings_goal` (`id`,`name`,`target_amount`,`currency_code`,`current_amount`,`target_date`,`icon_key`,`color_hex`,`notes`,`priority`,`is_completed`,`is_archived`,`is_deleted`,`created_at`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?,?,?,?,?)";
      }
    ...
    this.__insertionAdapterOfSavingsGoalEntity_1 = new EntityInsertionAdapter<SavingsGoalEntity>(__db) {
      @Override
      @NonNull
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `savings_goal` (`id`,`name`,`target_amount`,`currency_code`,`current_amount`,`target_date`,`icon_key`,`color_hex`,`notes`,`priority`,`is_completed`,`is_archived`,`is_deleted`,`created_at`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?,?,?,?,?)";
      }
    ...
    this.__insertionAdapterOfSavingsContributionEntity_1 = new EntityInsertionAdapter<SavingsContributionEntity>(__db) {
      @Override
      @NonNull
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `savings_contribution` (`id`,`savings_goal_id`,`amount`,`contribution_date`,`note`,`created_at`) VALUES (nullif(?, 0),?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfSavingsGoalEntity = new EntityDeletionOrUpdateAdapter<SavingsGoalEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `savings_goal` SET `id` = ?,`name` = ?,`target_amount` = ?,`currency_code` = ?,`current_amount` = ?,`target_date` = ?,`icon_key` = ?,`color_hex` = ?,`notes` = ?,`priority` = ?,`is_completed` = ?,`is_archived` = ?,`is_deleted` = ?,`created_at` = ? WHERE `id` = ?";
      }
    ...
    this.__preparedStmtOfDeleteAll = new SharedSQLiteStatement(__db) {
      ...
      public String createQuery() {
        final String _query = "DELETE FROM savings_goal";
        return _query;
      }
    };
    this.__preparedStmtOfDeleteAllContributions = new SharedSQLiteStatement(__db) {
      @Override
      @NonNull
      public String createQuery() {
        final String _query = "DELETE FROM savings_contribution";
        return _query;
      }
    };
  }
  ...
  @Override
  public Object insertAll(final List<SavingsGoalEntity> goals,
    ...
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      ...
      public Unit call() throws Exception {
        __db.beginTransaction();
        try {
          __insertionAdapterOfSavingsGoalEntity_1.insert(goals);
          __db.setTransactionSuccessful();
  ...
  @Override
  public Object insertAllContributions(final List<SavingsContributionEntity> contributions,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        __db.beginTransaction();
        try {
          __insertionAdapterOfSavingsContributionEntity_1.insert(contributions);
          __db.setTransactionSuccessful();
          return Unit.INSTANCE;
        } finally {
          __db.endTransaction();
  ...
  @Override
  public Object deleteAllContributions(final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        final SupportSQLiteStatement _stmt = __preparedStmtOfDeleteAllContributions.acquire();
        try {
          __db.beginTransaction();
          try {
            _stmt.executeUpdateDelete();
          ...
          __preparedStmtOfDeleteAllContributions.release(_stmt);
        }
      }
    }, $completion);
  }
      ...
      public SavingsGoalEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new SavingsGoalEntity(_tmpId,_tmpName,_tmpTargetAmount,_tmpCurrencyCode,_tmpCurrentAmount,_tmpTargetDate,_tmpIconKey,_tmpColorHex,_tmpNotes,_tmpPriority,_tmpIsCompleted,_tmpIsArchived,_tmpIsDeleted,_tmpCreatedAt);
          } else {
            _result = null;
          }
          return _result;
      ...
      public List<SavingsGoalEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new SavingsGoalEntity(_tmpId,_tmpName,_tmpTargetAmount,_tmpCurrencyCode,_tmpCurrentAmount,_tmpTargetDate,_tmpIconKey,_tmpColorHex,_tmpNotes,_tmpPriority,_tmpIsCompleted,_tmpIsArchived,_tmpIsDeleted,_tmpCreatedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Object sumContributions(final long goalId,
      final Continuation<? super Double> $completion) {
    final String _sql = "SELECT SUM(amount) FROM savings_contribution WHERE savings_goal_id = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    _statement.bindLong(_argIndex, goalId);
    final CancellationSignal _cancellationSignal = DBUtil.createCancellationSignal();
  ...
  @Override
  public Object getContributionById(final long id,
      final Continuation<? super SavingsContributionEntity> $completion) {
    final String _sql = "SELECT * FROM savings_contribution WHERE id = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    _statement.bindLong(_argIndex, id);
    final CancellationSignal _cancellationSignal = DBUtil.createCancellationSignal();
    return CoroutinesRoom.execute(__db, false, _cancellationSignal, new Callable<SavingsContributionEntity>() {
      @Override
      @Nullable
      public SavingsContributionEntity call() throws Exception {
        final Cursor _cursor = DBUtil.query(__db, _statement, false, null);
        try {
          final int _cursorIndexOfId = CursorUtil.getColumnIndexOrThrow(_cursor, "id");
          final int _cursorIndexOfSavingsGoalId = CursorUtil.getColumnIndexOrThrow(_cursor, "savings_goal_id");
          ...
          final int _cursorIndexOfNote = CursorUtil.getColumnIndexOrThrow(_cursor, "note");
          final int _cursorIndexOfCreatedAt = CursorUtil.getColumnIndexOrThrow(_cursor, "created_at");
          final SavingsContributionEntity _result;
          if (_cursor.moveToFirst()) {
            final long _tmpId;
            _tmpId = _cursor.getLong(_cursorIndexOfId);
            final long _tmpSavingsGoalId;
            ...
            _result = new SavingsContributionEntity(_tmpId,_tmpSavingsGoalId,_tmpAmount,_tmpContributionDate,_tmpNote,_tmpCreatedAt);
          } else {
            _result = null;
          }
          return _result;
  ...
  @Override
  public Object getAllEntities(final Continuation<? super List<SavingsGoalEntity>> $completion) {
  ...
  @Override
  public Object getAllContributionEntities(
      final Continuation<? super List<SavingsContributionEntity>> $completion) {
    final String _sql = "SELECT * FROM savings_contribution";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    final CancellationSignal _cancellationSignal = DBUtil.createCancellationSignal();
    return CoroutinesRoom.execute(__db, false, _cancellationSignal, new Callable<List<SavingsContributionEntity>>() {
      @Override
      @NonNull
      public List<SavingsContributionEntity> call() throws Exception {
        final Cursor _cursor = DBUtil.query(__db, _statement, false, null);
