...
public final class ReminderSyncWorker_Factory {
  ...
  public ReminderSyncWorker get(Context context, WorkerParameters params) {
    return newInstance(context, params, reminderDaoProvider.get(), reminderRepositoryProvider.get(), billRepositoryProvider.get(), notificationRepositoryProvider.get());
  }
  ...
  public static ReminderSyncWorker_Factory create(Provider<ReminderDao> reminderDaoProvider,
      ...
      Provider<BillRepository> billRepositoryProvider,
      Provider<NotificationRepository> notificationRepositoryProvider) {
    return new ReminderSyncWorker_Factory(reminderDaoProvider, reminderRepositoryProvider, billRepositoryProvider, notificationRepositoryProvider);
  }
  ...
  public static ReminderSyncWorker newInstance(Context context, WorkerParameters params,
    ...
    return new ReminderSyncWorker(context, params, reminderDao, reminderRepository, billRepository, notificationRepository);
  }
}
